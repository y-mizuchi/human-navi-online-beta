...
namespace NewtonVR
{
    public class NVRInteractableItem : NVRInteractable
    {
		...
		private bool isPhotonServerMachine;
		...
		protected override void Awake()
        {
            ...
            {
                this.isPhotonServerMachine = HumanNaviConfig.Instance.configInfo.photonServerMachine;
                //return;
            }
			...
			if (this.isPhotonServerMachine || this.isPlaybackMode)
			{
				return;
			}
